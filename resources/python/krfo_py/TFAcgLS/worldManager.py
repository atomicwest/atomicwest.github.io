...
class WorldManager(object):
    ...
    def __init__(self,worldMap,sprite_positions,x,y,dirx,diry,planex,planey):
        self.sprites = [  
              load_image(pygame.image.load("keyobj/officersprite64ded.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("keyobj/computer1.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("keyobj/officersprite64.png").convert(), False, colorKey = (0,0,0)),
        ]
        
        self.background = None
        self.images = [

              load_image(pygame.image.load("environment/panel1.png").convert(), False),
              load_image(pygame.image.load("environment/panel2.png").convert(), False),
              load_image(pygame.image.load("environment/panel3.png").convert(), False),
              load_image(pygame.image.load("environment/panel4.png").convert(), False),
              load_image(pygame.image.load("environment/panel5.png").convert(), False),
              load_image(pygame.image.load("keyobj/computerDamg.png").convert(), False),
              load_image(pygame.image.load("environment/panel7.png").convert(), False),
              load_image(pygame.image.load("environment/panel8.png").convert(), False),
    
              load_image(pygame.image.load("environment/panel1.png").convert(), True),
              load_image(pygame.image.load("environment/panel2.png").convert(), True),
              load_image(pygame.image.load("environment/panel3.png").convert(), True),
              load_image(pygame.image.load("environment/panel4.png").convert(), True),
              load_image(pygame.image.load("environment/panel5.png").convert(), True),
              load_image(pygame.image.load("keyobj/computerDamg.png").convert(), True),
              load_image(pygame.image.load("environment/panel7.png").convert(), True),
              load_image(pygame.image.load("environment/panel8.png").convert(), True),
    ...
    def draw(self, surface):
        ...
        if self.background is None:
            self.background = pygame.transform.scale(pygame.image.load("environment/background/backgroundGrey3.png").convert(), (w,h))
